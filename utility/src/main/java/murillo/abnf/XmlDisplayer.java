...
public class XmlDisplayer implements Visitor
{
  ...
  public Object visit(murillo.abnf.precomp.Token rule)
  {
    if (!terminal) System.out.println();
    System.out.print("<murillo.abnf.precomp.Token>");
  ...
  public Object visit(murillo.abnf.precomp.ByteString rule)
  {
    if (!terminal) System.out.println();
    System.out.print("<murillo.abnf.precomp.ByteString>");
    System.out.print(rule.spelling);
    System.out.print("</murillo.abnf.precomp.ByteString>");
    terminal = false;
    return null;
  ...
  public Object visit(murillo.abnf.precomp.CRLF rule)
  {
    if (!terminal) System.out.println();
    System.out.print("<murillo.abnf.precomp.CRLF>");
    System.out.print(rule.spelling);
    System.out.print("</murillo.abnf.precomp.CRLF>");
    terminal = false;
    return null;
  ...
  public Object visit(murillo.abnf.precomp.ALPHA rule)
  {
    if (!terminal) System.out.println();
    System.out.print("<murillo.abnf.precomp.ALPHA>");
    System.out.print(rule.spelling);
    System.out.print("</murillo.abnf.precomp.ALPHA>");
    terminal = false;
    return null;
