...
public class WaveController extends AudioController {
    ...
    private byte[] popHeader() throws IOException, HeaderFormatException {
        ...
        if (!new String(subChunkIDField, StandardCharsets.US_ASCII).equals("RIFF")) {
            throw new HeaderFormatException();
        }
        ...
        while (!new String(subChunkIDField, StandardCharsets.US_ASCII).equals("data"));
    ...
    private boolean parseHeader(byte[] header) throws UnsupportedEncodingException, UnsupportedFormatException {
        ...
        if (!new String(field, StandardCharsets.US_ASCII).equals("RIFF")) {
        ...
        if (!new String(field, StandardCharsets.US_ASCII).equals("WAVE")) {
            return false;
        }
        ...
        while (!new String(field, StandardCharsets.US_ASCII).equals("fmt "));
        ...
        while (!new String(field, StandardCharsets.US_ASCII).equals("data"));
