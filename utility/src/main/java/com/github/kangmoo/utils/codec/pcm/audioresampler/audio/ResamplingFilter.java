...
public class ResamplingFilter extends AudioFilter {
    ...
    public ResamplingFilter(int inSampleRate, int outSampleRate)
    {
        super();

        properties.SampleRate = inSampleRate;
    ...
    protected boolean validateInputParameters(int maxSampleRate, int maxBitDepth) {
        ...
        return maxBitDepth <= 0 || outProperties.BitsPerSample <= maxBitDepth;
    }
