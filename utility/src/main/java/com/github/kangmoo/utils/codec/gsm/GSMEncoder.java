 ...
 *
 */
package com.github.kangmoo.utils.codec.gsm;

import org.tritonus.lowlevel.gsm.*;
...
public class GSMEncoder {
    ...
    /* Reads 160 bytes */
    private final int[] input_signal = new int[160];
    /* [0..159]  OUT */
    /* Writes 33 bytes */
    ...
    public void encode(String input_file, String output_file)
        ...
        try (FileInputStream from = new FileInputStream(input_file);
             FileOutputStream to = new FileOutputStream(output_file)) {
    ...
    public void encode(InputStream input, String output_file)
            throws IOException {
        try (FileOutputStream to = new FileOutputStream(output_file)) {
