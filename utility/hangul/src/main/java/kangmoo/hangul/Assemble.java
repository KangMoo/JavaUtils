...
//        String disassembled = Disassemble.disassembleHangul(String.join("", words));
//        char[] disassembledChars = disassembled.toCharArray();
//        StringBuilder assembled = new StringBuilder();
//        for (char disassembledChar : disassembledChars) {
//            assembled.append(BinaryAssembleHangul.binaryAssembleHangul(disassembledChar));
//        }
